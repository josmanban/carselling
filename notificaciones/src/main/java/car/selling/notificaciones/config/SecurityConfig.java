package car.selling.notificaciones.config;
    ...
    public SecurityFilterChain publicSecurityChain(HttpSecurity http) throws Exception {
        http
            .securityMatcher(
                ...
                "/notificaciones/swagger-ui/**",
                "/notificaciones/swagger-ui.html",
                "/v3/api-docs/**",
                "/swagger-ui/**",
                "/swagger-ui.html"
            )
    ...
    public SecurityFilterChain apiSecurityChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/notificaciones/enviar-notificaciones").hasAnyRole("empleado")
                .requestMatchers("/notificaciones/**").hasAnyRole("empleado")
